        ...
        var e = {
            ...
            917: function(e) {
                e.exports = function() {
                      ...
                      , C = function(e, t) {
                        ...
                        var n = {
                            replace: function(t, r) {
                                return r = (r = r.source || r).replace(h, "$1"),
                                e = e.replace(t, r),
                                n
                            },
                            getRegex: function() {
                    ...
                    var M = function() {
                        ...
                        t.heading = function(e) {
                            ...
                            if (t) {
                                ...
                                return this.lexer.inline(o.text, o.tokens),
                                o
                            }
                        }
                        ,
                        ...
                        t.list = function(e) {
                            ...
                            if (t) {
                                var n, r, o, a, i, l, s, u, c, d, p = t[1].trim(), h = p.length > 1, v = {
                                    type: "list",
                                    raw: "",
                                    ordered: h,
                                    start: h ? +p.slice(0, -1) : "",
                                ...
                                for (var f = new RegExp("^( {0,3}" + p + ")((?: [^\\n]*| *)(?:\\n[^\\n]*)*(?:\\n|$))"); e && !this.rules.block.hr.test(e) && (t = f.exec(e)); ) {
                                    ...
                                    d = c[0].trimLeft()) : (a = t[2].search(/[^ ]/),
                                    a = t[1].length + (a > 4 ? 1 : a),
                                    d = c[0].slice(a - t[1].length)),
                                    l = !1,
                                    n = t[0],
                                    !c[0] && /^ *$/.test(c[1]) && (n = t[1] + c.slice(0, 2).join("\n") + "\n",
                                    v.loose = !0,
                                    c = []);
                                ...
                                v.items[v.items.length - 1].text = d.trimRight(),
                                v.raw = v.raw.trimRight();
                                var g = v.items.length;
                                for (i = 0; i < g; i++)
                                    this.lexer.state.top = !1,
                                    v.items[i].tokens = this.lexer.blockTokens(v.items[i].text, []),
                                    v.items[i].tokens.some((function(e) {
                                        return "space" === e.type
                                    }
                                    )) && (v.loose = !0,
                                    v.items[i].loose = !0);
                        ...
                        t.html = function(e) {
                            ...
                            if (t) {
                                ...
                                n.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : O(t[0]),
                                n.tokens = [],
                        ...
                        t.table = function(e) {
                            ...
                            if (t) {
                                ...
                                if (n.header.length === n.align.length) {
                                    ...
                                    for (l = n.rows.length,
                                    r = 0; r < l; r++)
                                        n.rows[r] = I(n.rows[r], n.header.length).map((function(e) {
                                            return {
                                                text: e
                                            }
                                        }
                                    ...
                                    o = 0; o < l; o++)
                                        ...
                                        a = 0; a < i.length; a++)
                                            i[a].tokens = [],
                                            this.lexer.inlineTokens(i[a].text, i[a].tokens);
                                    return n
                                }
                            }
                        }
                        ...
                        t.link = function(e) {
                            ...
                            if (t) {
                                ...
                                if (this.options.pedantic) {
                                    ...
                                    l = t[3] ? t[3].slice(1, -1) : "";
                                return i = i.trim(),
                                /^</.test(i) && (i = this.options.pedantic && !/>$/.test(n) ? i.slice(1) : i.slice(1, -1)),
                                $(t, {
                        ...
                        t.emStrong = function(e, t, n) {
                            ...
                            if (r && (!r[3] || !n.match(/(?:[0-9A-Za-z\xAA\xB2\xB3\xB5\xB9\xBA\xBC-\xBE\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u0660-\u0669\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07C0-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u08A0-\u08B4\u08B6-\u08C7\u0904-\u0939\u093D\u0950\u0958-\u0961\u0966-\u096F\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09E6-\u09F1\u09F4-\u09F9\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A66-\u0A6F\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AE6-\u0AEF\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B66-\u0B6F\u0B71-\u0B77\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0BE6-\u0BF2\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C60\u0C61\u0C66-\u0C6F\u0C78-\u0C7E\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0CE6-\u0CEF\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D58-\u0D61\u0D66-\u0D78\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0DE6-\u0DEF\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E50-\u0E59\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0ED0-\u0ED9\u0EDC-\u0EDF\u0F00\u0F20-\u0F33\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F-\u1049\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u1090-\u1099\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1369-\u137C\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16EE-\u16F8\u1700-\u170C\u170E-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u17E0-\u17E9\u17F0-\u17F9\u1810-\u1819\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1946-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u19D0-\u19DA\u1A00-\u1A16\u1A20-\u1A54\u1A80-\u1A89\u1A90-\u1A99\u1AA7\u1B05-\u1B33\u1B45-\u1B4B\u1B50-\u1B59\u1B83-\u1BA0\u1BAE-\u1BE5\u1C00-\u1C23\u1C40-\u1C49\u1C4D-\u1C7D\u1C80-\u1C88\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2070\u2071\u2074-\u2079\u207F-\u2089\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2150-\u2189\u2460-\u249B\u24EA-\u24FF\u2776-\u2793\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2CFD\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005-\u3007\u3021-\u3029\u3031-\u3035\u3038-\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u3192-\u3195\u31A0-\u31BF\u31F0-\u31FF\u3220-\u3229\u3248-\u324F\u3251-\u325F\u3280-\u3289\u32B1-\u32BF\u3400-\u4DBF\u4E00-\u9FFC\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6EF\uA717-\uA71F\uA722-\uA788\uA78B-\uA7BF\uA7C2-\uA7CA\uA7F5-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA830-\uA835\uA840-\uA873\uA882-\uA8B3\uA8D0-\uA8D9\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA900-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF-\uA9D9\uA9E0-\uA9E4\uA9E6-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA50-\uAA59\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uABF0-\uABF9\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF10-\uFF19\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDD07-\uDD33\uDD40-\uDD78\uDD8A\uDD8B\uDE80-\uDE9C\uDEA0-\uDED0\uDEE1-\uDEFB\uDF00-\uDF23\uDF2D-\uDF4A\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF\uDFD1-\uDFD5]|\uD801[\uDC00-\uDC9D\uDCA0-\uDCA9\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC58-\uDC76\uDC79-\uDC9E\uDCA7-\uDCAF\uDCE0-\uDCF2\uDCF4\uDCF5\uDCFB-\uDD1B\uDD20-\uDD39\uDD80-\uDDB7\uDDBC-\uDDCF\uDDD2-\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE40-\uDE48\uDE60-\uDE7E\uDE80-\uDE9F\uDEC0-\uDEC7\uDEC9-\uDEE4\uDEEB-\uDEEF\uDF00-\uDF35\uDF40-\uDF55\uDF58-\uDF72\uDF78-\uDF91\uDFA9-\uDFAF]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDCFA-\uDD23\uDD30-\uDD39\uDE60-\uDE7E\uDE80-\uDEA9\uDEB0\uDEB1\uDF00-\uDF27\uDF30-\uDF45\uDF51-\uDF54\uDFB0-\uDFCB\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC52-\uDC6F\uDC83-\uDCAF\uDCD0-\uDCE8\uDCF0-\uDCF9\uDD03-\uDD26\uDD36-\uDD3F\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDD0-\uDDDA\uDDDC\uDDE1-\uDDF4\uDE00-\uDE11\uDE13-\uDE2B\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDEF0-\uDEF9\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC50-\uDC59\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDCD0-\uDCD9\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE50-\uDE59\uDE80-\uDEAA\uDEB8\uDEC0-\uDEC9\uDF00-\uDF1A\uDF30-\uDF3B]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCF2\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDD50-\uDD59\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEC0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC50-\uDC6C\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD50-\uDD59\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDDA0-\uDDA9\uDEE0-\uDEF2\uDFB0\uDFC0-\uDFD4]|\uD808[\uDC00-\uDF99]|\uD809[\uDC00-\uDC6E\uDC80-\uDD43]|[\uD80C\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE60-\uDE69\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF50-\uDF59\uDF5B-\uDF61\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDE40-\uDE96\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDD00-\uDD08]|\uD82C[\uDC00-\uDD1E\uDD50-\uDD52\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD834[\uDEE0-\uDEF3\uDF60-\uDF78]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB\uDFCE-\uDFFF]|\uD838[\uDD00-\uDD2C\uDD37-\uDD3D\uDD40-\uDD49\uDD4E\uDEC0-\uDEEB\uDEF0-\uDEF9]|\uD83A[\uDC00-\uDCC4\uDCC7-\uDCCF\uDD00-\uDD43\uDD4B\uDD50-\uDD59]|\uD83B[\uDC71-\uDCAB\uDCAD-\uDCAF\uDCB1-\uDCB4\uDD01-\uDD2D\uDD2F-\uDD3D\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD83C[\uDD00-\uDD0C]|\uD83E[\uDFF0-\uDFF9]|\uD869[\uDC00-\uDEDD\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A])/))) {
                                ...
                                if (!o || o && ("" === n || this.rules.inline.punctuation.exec(n))) {
                                    var a, i, l = r[0].length - 1, s = l, u = 0, c = "*" === r[0][0] ? this.rules.inline.emStrong.rDelimAst : this.rules.inline.emStrong.rDelimUnd;
                                    for (c.lastIndex = 0,
                                    t = t.slice(-1 * e.length + l); null != (r = c.exec(t)); )
                        ...
                        t.autolink = function(e, t) {
                            ...
                            if (o)
                                return r = "@" === o[2] ? "mailto:" + (n = O(this.options.mangle ? t(o[1]) : o[1])) : n = O(o[1]),
                                {
                                    type: "link",
                                    raw: o[0],
                                    text: n,
                        ...
                        t.inlineText = function(e, t) {
                            ...
                            if (r)
                                return n = this.lexer.state.inRawBlock ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(r[0]) : O(r[0]) : r[0] : O(this.options.smartypants ? t(r[0]) : r[0]),
                                {
                                    type: "text",
                                    raw: r[0],
                                    text: n
                    ...
                    V.def = P(V.def).replace("label", V._label).replace("title", V._title).getRegex(),
                    V.bullet = /(?:[*+-]|\d{1,9}[.)])/,
                    V.listItemStart = P(/^( *)(bull) */).replace("bull", V.bullet).getRegex(),
                    V.list = P(V.list).replace(/bull/g, V.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + V.def.source + ")").getRegex(),
                    V._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
                    V._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
                    V.html = P(V.html, "i").replace("comment", V._comment).replace("tag", V._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
                    V.paragraph = P(V._paragraph).replace("hr", V.hr).replace("heading", " {0,3}#{1,6} ").replace("|lheading", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", V._tag).getRegex(),
                    V.blockquote = P(V.blockquote).replace("paragraph", V.paragraph).getRegex(),
                    V.normal = N({}, V),
                    V.gfm = N({}, V.normal, {
                    ...
                    q.punctuation = P(q.punctuation).replace(/punctuation/g, q._punctuation).getRegex(),
                    q.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,
                    q.escapedEmSt = /\\\*|\\_/g,
                    q._comment = P(V._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
                    q.emStrong.lDelim = P(q.emStrong.lDelim).replace(/punct/g, q._punctuation).getRegex(),
                    q.emStrong.rDelimAst = P(q.emStrong.rDelimAst, "g").replace(/punct/g, q._punctuation).getRegex(),
                    q.emStrong.rDelimUnd = P(q.emStrong.rDelimUnd, "g").replace(/punct/g, q._punctuation).getRegex(),
                    q._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
                    ...
                    q.autolink = P(q.autolink).replace("scheme", q._scheme).replace("email", q._email).getRegex(),
                    q._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
                    q.tag = P(q.tag).replace("comment", q._comment).replace("attribute", q._attribute).getRegex(),
                    q._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
                    q._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,
                    q._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
                    q.link = P(q.link).replace("label", q._label).replace("href", q._href).replace("title", q._title).getRegex(),
                    q.reflink = P(q.reflink).replace("label", q._label).getRegex(),
                    q.reflinkSearch = P(q.reflinkSearch, "g").replace("reflink", q.reflink).replace("nolink", q.nolink).getRegex(),
                    q.normal = N({}, q),
                    q.pedantic = N({}, q.normal, {
                        strong: {
                            start: /^__|\*\*/,
                    ...
                    q.gfm.url = P(q.gfm.url, "i").replace("email", q.gfm._extended_email).getRegex(),
                    q.breaks = N({}, q.gfm, {
                    ...
                    var G = function() {
                        function t(e) {
                            ...
                            t.inline = K.pedantic) : this.options.gfm && (t.block = J.gfm,
                        ...
                        a.inlineTokens = function(e, t) {
                            ...
                            if (this.tokens.links) {
                                ...
                                if (c.length > 0)
                                    for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(u)); )
                                        c.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (u = u.slice(0, i.index) + "[" + Q("a", i[0].length - 2) + "]" + u.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
                            }
                            for (; null != (i = this.tokenizer.rules.inline.blockSkip.exec(u)); )
                                u = u.slice(0, i.index) + "[" + Q("a", i[0].length - 2) + "]" + u.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                            for (; null != (i = this.tokenizer.rules.inline.escapedEmSt.exec(u)); )
                                u = u.slice(0, i.index) + "++" + u.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex);
                            for (; e; )
                                if (l || (s = ""),
                                l = !1,
                                !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some((function(r) {
                                    ...
                                    if (n = this.tokenizer.escape(e))
                                        ...
                                        e = e.substring(n.raw.length),
                                        t.push(n);
                                    else if (n = this.tokenizer.autolink(e, X))
                                        e = e.substring(n.raw.length),
                                        t.push(n);
                                        ...
                                        n = this.tokenizer.inlineText(o, Y))
                                            e = e.substring(n.raw.length),
                            ...
                            for (n = 0; n < k; n++)
                                ...
                                !(this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[d.type]) || !1 === (w = this.options.extensions.renderers[d.type].call({
                                    ...
                                    case "list":
                                        ...
                                        c = "",
                                        r = 0; r < a; r++)
                                            g = (m = d.items[r]).checked,
                                            b = m.task,
                                            f = "",
                                            m.task && (D = this.renderer.checkbox(g),
                                            ...
                                            f += this.parse(m.tokens, v),
                                            c += this.renderer.listitem(f, b, g);
                    ...
                    function Ce(e, t, n) {
                        ...
                        n) {
                            ...
                            var a = function(e) {
                                ...
                                if (!e)
                                    try {
                                        t.walkTokens && Ce.walkTokens(r, t.walkTokens),
                                        a = he.parse(r, t)
                                    } catch (t) {
                                        e = t
                                    }
                        ...
                        try {
                            var l = pe.lex(e, t);
                            return t.walkTokens && Ce.walkTokens(l, t.walkTokens),
                            he.parse(l, t)
                        } catch (e) {
                    ...
                    Ce.parseInline = function(e, t) {
                        ...
                        try {
                            ...
                            return t.walkTokens && Ce.walkTokens(n, t.walkTokens),
                            he.parseInline(n, t)
                        } catch (e) {
                            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.",
                            t.silent)
        ...
        return (()=>{
            ...
            function De(e, t, n, r, o, a) {
                ...
                if ("clear" === t)
                    ...
                    t) {
                    case "add":
                        C(e) ? O(n) && l.push(i.get("length")) : (l.push(i.get(se)),
                        E(e) && l.push(i.get(ue)));
                        break;
                    case "delete":
                        C(e) || (l.push(i.get(se)),
            ...
            function _e(e=!1, t=!1) {
                return function(n, r, o) {
                    ...
                    return (S(r) ? ke.has(r) : ye(r)) ? i : (e || me(n, 0, r),
                    t ? i : mt(i) ? a && O(r) ? i : i.value : z(i) ? e ? at(i) : ot(i) : i)
                }
            }
            function Be(e=!1) {
                return function(t, n, r, o) {
                    ...
                    return t === ct(o) && (i ? H(r, a) && De(t, "set", n, r) : De(t, "add", n, r)),
                    l
                }
            }
            const Se = {
                ...
                has: function(e, t) {
                    ...
                    return S(t) && ke.has(t) || me(e, 0, t),
                    n
                },
                ownKeys: function(e) {
                    return me(e, 0, C(e) ? "length" : se),
                    Reflect.ownKeys(e)
                }
            }
              , ze = {
            ...
            function $e(e) {
                e = ct(e);
                const t = ct(this);
                return Re(t).has.call(t, e) || (t.add(e),
                De(t, "add", e, e)),
                this
            }
            function Me(e, t) {
                ...
                const i = o.call(n, e);
                return n.set(e, t),
                a ? H(t, i) && De(n, "set", e, t) : De(n, "add", e, t),
                this
            }
            function Ue(e) {
                const t = ct(this)
            ...
            function At(e, t) {
                xt = e,
                xt ? (xt.enabled = !0,
                Ct.forEach((({event: e, args: t})=>xt.emit(e, ...t))),
                Ct = []) : (t.__VUE_DEVTOOLS_HOOK_REPLAY__ = t.__VUE_DEVTOOLS_HOOK_REPLAY__ || []).push((e=>{
                    At(e, t)
                }
                ))
            }
            ...
            function Lt(e, t, n=!1) {
                ...
                const a = e.emits;
                let i = {};
                return a ? (C(a) ? a.forEach((e=>i[e] = null)) : y(i, a),
                r.set(e, i),
                i) : (r.set(e, null),
                null)
            }
            function Tt(e, t) {
                return !(!e || !D(t)) && (t = t.slice(2).replace(/Once$/, ""),
            ...
            function Ot(e) {
                const t = Rt;
                return Rt = e,
                It = e && e.type.__scopeId || null,
                t
            }
            function jt(e) {
                const {type: t, vnode: n, proxy: r, withProxy: o, props: a, propsOptions: [i], slots: l, attrs: s, emit: u, render: c, renderCache: d, data: p, setupState: h, ctx: v, inheritAttrs: f} = e;
                let m, g;
                const b = Ot(e);
                try {
                    if (4 & n.shapeFlag) {
                        const e = o || r;
                        m = Xn(c.call(e, e, d, a, h, p, v)),
                        g = s
                    } else {
                        const e = t;
                        m = Xn(e.length > 1 ? e(a, {
                ...
                if (g && !1 !== f) {
                    const e = Object.keys(g)
                      , {shapeFlag: t} = D;
                    e.length && 7 & t && (i && e.some(w) && (g = Mt(g, i)),
                    D = Kn(D, g))
                }
                return n.dirs && (D.dirs = D.dirs ? D.dirs.concat(n.dirs) : n.dirs),
            ...
            function Ht(e, t, n, r) {
                const {appear: o, mode: a, persisted: i=!1, onBeforeEnter: l, onEnter: s, onAfterEnter: u, onEnterCancelled: c, onBeforeLeave: d, onLeave: p, onAfterLeave: h, onLeaveCancelled: v, onBeforeAppear: f, onAppear: m, onAfterAppear: g, onAppearCancelled: b} = t
                  , D = String(e.key)
                  , w = qt(n, e)
                  , y = (e,t)=>{
                    e && gr(e, r, 9, t)
                  ...
                  , k = {
                    ...
                    beforeEnter(t) {
                        ...
                        const a = w[D];
                        a && Vn(e, a) && a.el._leaveCb && a.el._leaveCb(),
                        y(r, [t])
                    },
                    enter(e) {
                        let t = s
            ...
            function Kt(e, t=!1) {
                ...
                for (let o = 0; o < e.length; o++) {
                    ...
                    n = n.concat(Kt(a.children, t))) : (t || a.type !== Ln) && n.push(a)
                }
                if (r > 1)
            ...
            function rn(e, t, n, r) {
                ...
                if (t)
                    for (let s in t) {
                        ...
                        const u = t[s];
                        let c;
                        o && x(o, c = U(s)) ? a && a.includes(c) ? (i || (i = {}))[c] = u : n[c] = u : Tt(e.emitsOptions, s) || u !== r[s] && (r[s] = u,
                        l = !0)
                    }
                if (a) {
                    const t = ct(n)
            ...
            function wn(e, t) {
                return function(n, r=null) {
                    ...
                    const l = o.app = {
                        ...
                        set config(e) {},
                        use: (e,...t)=>(a.has(e) || (e && _(e.install) ? (a.add(e),
                        e.install(l, ...t)) : _(e) && (a.add(e),
                        e(l, ...t))),
                        l),
                        mixin: e=>l,
                        ...
                        mount(a, s, u) {
                            if (!i) {
                                ...
                                l._container = a,
                                a.__vue_app__ = l,
                                __VUE_PROD_DEVTOOLS__ && (l._instance = c.component,
                                function(e, t) {
                                    Et("app:init", e, t, {
                                        Fragment: Sn,
                                        Text: zn,
                                ...
                                fr(c.component) || c.component.proxy
                            }
                        },
                        unmount() {
                            i && (e(null, l._container),
                            __VUE_PROD_DEVTOOLS__ && (l._instance = null,
                            function(e) {
                                Et("app:unmount", e)
                            }(l)),
            ...
            function kn(e, t) {
                ...
                const n = Q();
                n.__VUE__ = !0,
                __VUE_PROD_DEVTOOLS__ && At(n.__VUE_DEVTOOLS_GLOBAL_HOOK__, n);
                const {insert: r, remove: o, patchProp: a, createElement: i, createText: l, createComment: s, setText: u, setElementText: c, parentNode: d, nextSibling: p, setScopeId: h=m, cloneNode: g, insertStaticContent: b} = e
                  , D = (e,t,n,r=null,o=null,a=null,i=!1,l=null,s=!!t.dynamicChildren)=>{
                    if (e === t)
                        return;
                    e && !Vn(e, t) && (r = te(e),
                    J(e, o, a, !0),
                  ...
                  , E = (e,t,n,r,o,a,i,l,s)=>{
                    i = i || "svg" === t.type,
                    null == e ? A(t, n, r, o, a, i, l, s) : B(e, t, o, a, i, l, s)
                }
                  , A = (e,t,n,o,l,s,u,d)=>{
                    let p, h;
                    const {type: v, props: f, shapeFlag: m, transition: b, patchFlag: D, dirs: w} = e;
                    if (e.el && void 0 !== g && -1 === D)
                        p = e.el = g(e.el);
                    else {
                        if (p = e.el = i(e.type, s, f && f.is, f),
                        8 & m ? c(p, e.children) : 16 & m && _(e.children, p, null, o, l, s && "foreignObject" !== v, u, d),
                        w && gn(e, null, o, "created"),
                        f) {
                            for (const t in f)
                                "value" === t || j(t) || a(p, t, null, f[t], s, e.children, o, l, ee);
                            "value"in f && a(p, "value", null, f.value),
                            (h = f.onVnodeBeforeMount) && Cn(h, o, e)
                        }
                        F(p, e, e.scopeId, u, o)
                    }
                    ...
                    y && b.beforeEnter(p),
                    r(p, t, n),
                    ((h = f && f.onVnodeMounted) || y || w) && yn((()=>{
                        h && Cn(h, o, e),
                        y && b.enter(p),
                        w && gn(e, null, o, "mounted")
                    }
                    ), l)
                }
                  , F = (e,t,n,r,o)=>{
                  ...
                  , B = (e,t,n,r,o,i,l)=>{
                    ...
                    const h = e.props || v
                      , f = t.props || v;
                    let m;
                    (m = f.onVnodeBeforeUpdate) && Cn(m, n, t, e),
                    p && gn(t, e, n, "beforeUpdate");
                    const g = o && "foreignObject" !== t.type;
                    if (d ? S(e.dynamicChildren, d, s, n, r, g, i) : l || P(e, t, s, null, n, r, g, i, !1),
                    u > 0) {
                        if (16 & u)
                            z(s, t, h, f, n, r, o);
                        else if (2 & u && h.class !== f.class && a(s, "class", null, f.class, o),
                        4 & u && a(s, "style", h.style, f.style, o),
                        8 & u) {
                  ...
                  , T = (e,t,n,o,a,i,s,u,c)=>{
                    ...
                    let {patchFlag: h, dynamicChildren: v, slotScopeIds: f} = t;
                    f && (u = u ? u.concat(f) : f),
                    null == e ? (r(d, n, o),
                    r(p, n, o),
                    _(t.children, n, p, a, i, s, u, c)) : h > 0 && 64 & h && v && e.dynamicChildren ? (S(e.dynamicChildren, v, n, a, i, s, u),
                    (null != t.key || a && t === a.subTree) && En(e, t, !0)) : P(e, t, n, p, a, i, s, u, c)
                }
                  , R = (e,t,n,r,o,a,i,l,s)=>{
                    t.slotScopeIds = l,
                    null == e ? 512 & t.shapeFlag ? o.ctx.activate(t, n, r, i, s) : I(t, n, r, o, a, i, s) : O(e, t, s)
                }
                  , I = (e,t,n,r,o,a,i)=>{
                  ...
                  , $ = (e,t,n,r,o,a,i)=>{
                    const l = new ce((()=>{
                        if (e.isMounted) {
                            let t, {next: n, bu: r, u: s, parent: u, vnode: c} = e, p = n;
                            l.allowRecurse = !1,
                            n ? (n.el = c.el,
                            M(e, n, i)) : n = c,
                            r && W(r),
                            (t = n.props && n.props.onVnodeBeforeUpdate) && Cn(t, u, n, c),
                            l.allowRecurse = !0;
                            const h = jt(e)
                              , v = e.subTree;
                            e.subTree = h,
                            D(v, h, d(v.el), te(v), e, o, a),
                            n.el = h.el,
                            ...
                            s && yn(s, o),
                            (t = n.props && n.props.onVnodeUpdated) && yn((()=>Cn(t, u, n, c)), o),
                            __VUE_PROD_DEVTOOLS__ && _t(e)
                        } else {
                            let i;
                            ...
                            if (l.allowRecurse = !1,
                            c && W(c),
                            !h && (i = u && u.onVnodeBeforeMount) && Cn(i, p, t),
                            l.allowRecurse = !0,
                            s && ae) {
                                const n = ()=>{
                                    e.subTree = jt(e),
                                    ae(s, e.subTree, e, o, null)
                                }
                                ;
                            ...
                            if (d && yn(d, o),
                            !h && (i = u && u.onVnodeMounted)) {
                                const e = t;
                                yn((()=>Cn(i, p, e)), o)
                            }
                            256 & t.shapeFlag && e.a && yn(e.a, o),
                            e.isMounted = !0,
                    ...
                    s.id = e.uid,
                    l.allowRecurse = s.allowRecurse = !0,
                    s()
                }
                  , M = (e,t,n)=>{
                    t.component = e;
                    ...
                    function(e, t, n, r) {
                        ...
                        if (!(r || i > 0) || 16 & i) {
                            ...
                            rn(e, t, o, a) && (u = !0);
                            for (const a in l)
                                t && (x(t, a) || (r = N(a)) !== a && x(t, r)) || (s ? !n || void 0 === n[a] && void 0 === n[r] || (o[a] = on(s, l, a, void 0, e, !0)) : delete o[a]);
                            if (a !== l)
                                for (const e in a)
                                    t && x(t, e) || (delete a[e],
                                    u = !0)
                  ...
                  , P = (e,t,n,r,o,a,i,l,s=!1)=>{
                    ...
                    8 & v ? (16 & d && ee(u, o, a),
                    p !== u && c(n, p)) : 16 & d ? 16 & v ? q(u, p, n, r, o, a, i, l, s) : ee(u, o, a, !0) : (8 & d && c(n, ""),
                    16 & v && _(p, n, r, o, a, i, l, s))
                }
                  , V = (e,t,n,r,o,a,i,l,s)=>{
                    t = t || f;
                    ...
                    if (u > d) {
                        if (u <= p) {
                            const e = p + 1
                              , d = e < c ? t[e].el : r;
                            for (; u <= p; )
                                D(null, t[u] = s ? Gn(t[u]) : Xn(t[u]), n, d, o, a, i, l, s),
                                u++
                        }
                    } else if (u > p)
                        for (; u <= d; )
                        ...
                        for (u = h; u <= d; u++) {
                            ...
                            void 0 === c ? J(r, o, a, !0) : (x[c - v] = u + 1,
                            c >= k ? k = c : y = !0,
                            D(r, t[c], n, null, o, a, i, l, s),
                            b++)
                        }
                  ...
                  , H = (e,t,n,o,a=null)=>{
                    const {el: i, type: l, transition: s, children: u, shapeFlag: c} = e;
                    if (6 & c)
                  ...
                  , J = (e,t,n,r=!1,o=!1)=>{
                    const {type: a, props: i, ref: l, children: s, dynamicChildren: u, shapeFlag: c, patchFlag: d, dirs: p} = e;
                    if (null != l && xn(l, null, n, e, !0),
                    256 & c)
                        return void t.ctx.deactivate(e);
                    const h = 1 & c && p
                      , v = !Yt(e);
                    let f;
                    if (v && (f = i && i.onVnodeBeforeUnmount) && Cn(f, t, e),
                    6 & c)
                        X(e.component, n, r);
                    else {
                        if (128 & c)
                            return void e.suspense.unmount(n, r);
                        h && gn(e, null, t, "beforeUnmount"),
                        64 & c ? e.type.remove(e, t, n, o, re, r) : u && (a !== Sn || d > 0 && 64 & d) ? ee(u, t, n, !1, !0) : (a === Sn && 384 & d || !o && 16 & c) && ee(s, t, n),
                        r && K(e)
                    }
                    (v && (f = i && i.onVnodeUnmounted) || h) && yn((()=>{
                        f && Cn(f, t, e),
                        h && gn(e, null, t, "unmounted")
                    }
                    ), n)
                }
                  , K = e=>{
                  ...
                  , X = (e,t,n)=>{
                    const {bum: r, scope: o, update: a, subTree: i, um: l} = e;
                    r && W(r),
                    o.stop(),
                    a && (a.active = !1,
                    J(i, e, t, n)),
                  ...
                  , ne = (e,t,n)=>{
                    null == e ? t._vnode && J(t._vnode, null, null, !0) : D(t._vnode || null, e, t, null, null, null, n),
                    jr(),
                    t._vnode = e
                }
                  , re = {
            ...
            function xn(e, t, n, r, o=!1) {
                ...
                const a = 4 & r.shapeFlag ? fr(r.component) || r.component.proxy : r.el
                  ...
                  , d = l.setupState;
                if (null != u && u !== s && (B(u) ? (c[u] = null,
                x(d, u) && (d[u] = null)) : mt(u) && (u.value = null)),
                B(s)) {
                    const e = ()=>{
                        c[s] = i,
                        x(d, s) && (d[s] = i)
            ...
            function Mn(e) {
                return e.dynamicChildren = jn > 0 ? In || f : null,
                Rn.pop(),
                In = Rn[Rn.length - 1] || null,
                jn > 0 && In && In.push(e),
                e
            }
            ...
            function Zn(e, t=null, n=null, r=0, o=null, a=(e === Sn ? 0 : 1), i=!1, l=!1) {
                ...
                return l ? (er(s, n),
                128 & a && e.normalize(s)) : n && (s.shapeFlag |= B(n) ? 8 : 16),
                jn > 0 && !i && In && (s.patchFlag > 0 || 6 & a) && 32 !== s.patchFlag && In.push(s),
                s
            }
            const Jn = function(e, t=null, n=null, r=0, o=null, i=!1) {
                ...
                if (l = e,
                _(l) && "__vccOpts"in l && (e = e.__vccOpts),
                t) {
                    t = function(e) {
            ...
            function er(e, t) {
                ...
                if (null == t)
                    ...
                    }
                    {
                        n = 32;
                        const r = t._;
                        r || qn in t ? 3 === r && Rt && (1 === Rt.slots._ ? t._ = 1 : (t._ = 2,
                        e.patchFlag |= 1024)) : t._ctx = Rt
                    }
                } else
                    _(t) ? (t = {
                        default: t,
            ...
            const nr = e=>e ? dr(e) ? fr(e) || e.proxy : nr(e.parent) : null
              ...
              , or = {
                get({_: e}, t) {
                    const {ctx: n, setupState: r, data: o, props: a, accessCache: i, type: l, appContext: s} = e;
                    let u;
                    if ("$" !== t[0]) {
                        const l = i[t];
                        if (void 0 !== l)
                    ...
                    const c = rr[t];
                    let d, p;
                    return c ? ("$attrs" === t && me(e, 0, t),
                    c(e)) : (d = l.__cssModules) && (d = d[t]) ? d : n !== v && x(n, t) ? (i[t] = 3,
                    n[t]) : (p = s.config.globalProperties,
                    x(p, t) ? p[t] : void 0)
                },
                set({_: e}, t, n) {
                    ...
                    if (o !== v && x(o, t))
                        ...
                        return !1;
                    return !("$" === t[0] && t.slice(1)in e || (a[t] = n,
                    0))
                },
            ...
            function Ir(e, t, n, r) {
                C(e) ? n.push(...e) : t && t.includes(e, e.allowRecurse ? r + 1 : r) || n.push(e),
                Rr()
            }
            ...
            function Mr(e) {
                ...
                try {
                    ...
                    Dr = !1,
                    Sr = null,
                    (yr.length || xr.length || Ar.length) && Mr(e)
                }
            }
            const Ur = {};
            function Pr(e, t, n) {
                return function(e, t, {immediate: n, deep: r, flush: o, onTrack: a, onTrigger: i}=v) {
                    const l = lr;
                    let s, u, c = !1, d = !1;
                    if (mt(e) ? (s = ()=>e.value,
                    c = !!e._shallow) : lt(e) ? (s = ()=>e,
                    r = !0) : C(e) ? (d = !0,
                    c = e.some(lt),
                    s = ()=>e.map((e=>mt(e) ? e.value : lt(e) ? Nr(e) : _(e) ? mr(e, l, 2) : void 0))) : s = _(e) ? t ? ()=>mr(e, l, 2) : ()=>{
                        if (!l || !l.isUnmounted)
                            return u && u(),
                            gr(e, l, 3, [p])
                    }
                    ...
                    const f = ()=>{
                        if (b.active)
                            if (t) {
                                const e = b.run();
                                (r || c || (d ? e.some(((e,t)=>H(e, h[t]))) : H(e, h))) && (u && u(),
                                gr(t, l, 3, [e, h === Ur ? void 0 : h, p]),
                                h = e)
                            } else
                                b.run()
                    }
                    ...
                    let g;
                    f.allowRecurse = !!t,
                    g = "sync" === o ? f : "post" === o ? ()=>yn(f, l && l.suspense) : ()=>{
            ...
            function Vr(e, t, n) {
                ...
                return 2 === r ? z(t) && !C(t) ? Nn(t) ? Jn(e, null, [t]) : Jn(e, t) : Jn(e, null, t) : (r > 3 ? n = Array.prototype.slice.call(arguments, 2) : 3 === r && Nn(n) && (n = [n]),
                Jn(e, t, n))
            }
            Symbol("");
            const qr = "3.2.19"
            ...
            const lo = "transition"
              , so = "animation"
              , uo = (e,{slots: t})=>Vr(Vt, function(e) {
                const t = {};
                for (const n in e)
                    n in co || (t[n] = e[n]);
                if (!1 === e.css)
                    return t;
                const {name: n="v", type: r, duration: o, enterFromClass: a=`${n}-enter-from`, enterActiveClass: i=`${n}-enter-active`, enterToClass: l=`${n}-enter-to`, appearFromClass: s=a, appearActiveClass: u=i, appearToClass: c=l, leaveFromClass: d=`${n}-leave-from`, leaveActiveClass: p=`${n}-leave-active`, leaveToClass: h=`${n}-leave-to`} = e
                  , v = function(e) {
                    if (null == e)
                        return null;
                    if (z(e))
                  ...
                  , f = v && v[0]
                  , m = v && v[1]
                  , {onBeforeEnter: g, onEnter: b, onEnterCancelled: D, onLeave: w, onLeaveCancelled: k, onBeforeAppear: x=g, onAppear: C=b, onAppearCancelled: E=D} = t
                  , A = (e,t,n)=>{
                    mo(e, t ? c : l),
                    mo(e, t ? u : i),
                    n && n()
            ...
            function Do(e, t, n, r) {
                ...
                const {type: i, timeout: l, propCount: s} = function(e, t) {
                    ...
                    let c = null
                      , d = 0
                      , p = 0;
                    return t === lo ? i > 0 && (c = lo,
                    d = i,
                    p = a.length) : t === so ? u > 0 && (c = so,
                    d = u,
                    p = s.length) : (d = Math.max(i, u),
                    c = d > 0 ? i > u ? lo : so : null,
                    p = c ? c === lo ? a.length : s.length : 0),
                    {
                        type: c,
                        timeout: d,
                        propCount: p,
            ...
            const Eo = {
                created(e, {modifiers: {lazy: t, trim: n, number: r}}, o) {
                    ...
                    t || (oo(e, "compositionstart", xo),
                    oo(e, "compositionend", Co),
                    oo(e, "change", Co))
                },
                mounted(e, {value: t}) {
                    e.value = null == t ? "" : t
            ...
            function Fo(e, {value: t, oldValue: n}, r) {
                e._modelValue = t,
                C(t) ? e.checked = d(t, r.props.value) > -1 : A(t) ? e.checked = t.has(r.props.value) : t !== n && (e.checked = c(t, Lo(e, !0)))
            }
            const _o = {
                created(e, {value: t}, n) {
                    e.checked = c(t, n.props.value),
                    e._assign = ko(n),
                    oo(e, "change", (()=>{
                        e._assign(zo(e))
                    }
                ...
                beforeUpdate(e, {value: t, oldValue: n}, r) {
                    e._assign = ko(r),
                    t !== n && (e.checked = c(t, r.props.value))
                }
            }
              , Bo = {
                deep: !0,
                ...
                if (!n || C(t) || A(t)) {
                    for (let r = 0, o = e.options.length; r < o; r++) {
                        const o = e.options[r]
                          , a = zo(o);
                        if (n)
                            C(t) ? o.selected = d(t, a) > -1 : o.selected = t.has(a);
                        else if (c(zo(o), t))
            ...
            const Io = y({
                patchProp: (e,n,r,a,i=!1,l,s,u,c)=>{
                    ...
                    }(e, n, a, l, s, u, c) : ("true-value" === n ? e._trueValue = a : "false-value" === n && (e._falseValue = a),
                    function(e, n, r, a, i) {
                        if (a && n.startsWith("xlink:"))
                            null == r ? e.removeAttributeNS(Xr, n.slice(6, n.length)) : e.setAttributeNS(Xr, n, r);
                        else {
                            const a = t(n);
            ...
            let Oo;
            const jo = (e,t,n="")=>"object" == typeof e && e.errno ? (console.error("Fetch ".concat(n, " failed with ").concat(e.errno, ": ").concat(e.errmsg)),
            t) : e
              , $o = e=>{
                try {
                    e = decodeURI(e)
              ...
              , qo = e=>{
                ...
                return t.append("image", e),
                fetch("https://pic.alexhchu.com/api/upload", {
                    method: "POST",
                    body: t
              ...
              , Yo = e=>{
                ...
                return {
                    ...
                    set(n, r) {
                        try {
                            t[n] = JSON.parse(JSON.stringify(r)),
            ...
            const Go = (e,t,n="",r="")=>"".concat(t, "/").concat(n).concat(e).concat(r ? ".".concat(r) : "")
              , ea = ({el: e="#waline", serverURL: t, placeholder: n, langMode: r, emojiCDN: o, emojiMaps: a, requiredFields: i=[], anonymous: l, avatarCDN: s, avatar: u, avatarForce: c, path: d=location.pathname, lang: p="zh-CN", locale: h=r, emoji: v=["https://cdn.jsdelivr.net/gh/walinejs/emojis@1.0.0/weibo"], meta: f=["nick", "mail", "link"], requiredMeta: m=i, pageSize: g=10, wordLimit: b, uploadImage: D, copyright: w=!0, login: y=(!0 === l ? "disable" : !1 === l ? "force" : "enable"), ...k})=>{
                const x = Qo[p] || Qo["zh-CN"];
                n && (x.placeholder = n);
                const C = o && "object" == typeof a ? Promise.resolve(((e,t="")=>{
                    const n = {};
                    for (const r in e)
                        n[r] = /(?:https?:)?\/\//.test(e[r]) ? e[r] : "".concat(t).concat(e[r]);
                    return {
                        tabs: [{
                            name: "Emoji",
                ...
                Promise.all(E.map((e=>"string" == typeof e ? (e=>{
                    ...
                    return e.forEach((e=>{
                        const {name: n, folder: r, icon: o, prefix: a, type: i, items: l} = e;
                        t.tabs.push({
                            name: n,
                            icon: Go(o, r, a, i),
                            items: l.map((e=>{
                                const n = "".concat(a || "").concat(e);
                                return t.map[n] = Go(e, r, a, i),
                                n
                            }
                            ))
                        })
              ...
              , aa = ()=>{
                ...
                (Math.abs(t.height - 23) > 1 || Math.abs(t.width - 77) > 1) && document.body.setAttribute("waline-math", "")
            }
            ;
            var ia = n(948)
              , la = n.n(ia)
            ...
            ;
            let ma, ga;
            const ba = ()=>(ga || (ma = Yo("WALINE_USER_CACHE"),
            ga = ot({
                nick: ma.get("nick") || "",
                mail: ma.get("mail") || "",
                link: ma.get("link") || "",
            ...
            })),
            {
              ...
              , ui = ["src", "alt", "title"]
              , ci = ["title"];
            var di, pi, hi = "function" == typeof Map ? new Map : (di = [],
            pi = [],
            {
                has: function(e) {
            ...
            gi.update = function(e) {
                ...
                return e && Array.prototype.forEach.call(e.length ? e : [e], (function(e) {
                    return function(e) {
                        if (e && e.nodeName && "TEXTAREA" === e.nodeName && !hi.has(e)) {
                            var t, n = null, r = null, o = null, a = function() {
                                e.clientWidth !== r && u()
                            }, i = function(t) {
                            ...
                            "onpropertychange"in e && "oninput"in e && e.addEventListener("keyup", u, !1),
                        ...
                        function u() {
                            ...
                            if (r < t ? "hidden" === n.overflowY && (l("scroll"),
                            s(),
                            r = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight) : "hidden" !== n.overflowY && (l("hidden"),
                            s(),
                            r = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight),
                            o !== r) {
                                o = r;
                ...
                return e && Array.prototype.forEach.call(e.length ? e : [e], fi),
                e
            }
            ,
            gi.update = function(e) {
                return e && Array.prototype.forEach.call(e.length ? e : [e], mi),
                e
            }
            );
            const bi = gi
                ...
                setup(e, {emit: t}) {
                    const n = Pt("config")
                      ...
                      , A = e=>{
                        ...
                        return E(t),
                        Promise.resolve().then((()=>n.value.uploadImage(e))).then((n=>{
                      ...
                      , F = ()=>{
                        var i, u;
                        const {serverURL: c, lang: d, login: h, wordLimit: v, requiredMeta: f} = n.value
                          , b = {
                            comment: w.value,
                            nick: r.nick,
                            mail: r.mail,
                        ...
                        if (null !== (i = a.value) && void 0 !== i && i.token)
                            b.nick = a.value.display_name,
                            b.mail = a.value.email,
                            b.link = a.value.url;
                        else {
                            if ("force" === h)
                                return;
                            var x, C, E;
                            if ((f.indexOf("nick") > -1 || b.nick) && b.nick.length < 3)
                                return null === (x = l.value.nick) || void 0 === x || x.focus(),
                                alert(k.value.nickError);
                            if ((f.indexOf("mail") > -1 || b.mail) && !/^(\w)+([._-]\w+)*@(\w)+((\.\w{2,}){1,3})$/.exec(b.mail))
                                return null === (C = l.value.mail) || void 0 === C || C.focus(),
                                alert(k.value.mailError);
                            if (!b.comment)
                                return void (null === (E = s.value) || void 0 === E || E.focus());
                            b.nick = b.nick || "Anonymous"
                        }
                        if (!D.value)
                            return alert(k.value.wordHint.replace("$0", v[0].toString()).replace("$1", v[1].toString()).replace("$2", g.value.toString()));
                        b.comment = pa(b.comment, p.value.map),
                        e.replyId && e.rootId && (b.pid = e.replyId,
                        b.rid = e.rootId,
                        b.at = e.replyUser),
                        y.value = !0,
                        (({serverURL: e, lang: t, token: n, comment: r})=>{
                            ...
                            return n && (o.Authorization = "Bearer ".concat(n)),
                            fetch("".concat(e, "/comment?lang=").concat(t), {
                                method: "POST",
                                headers: o,
                            ...
                            n.errmsg)
                                return alert(n.errmsg);
                            t("submit", n.data),
                            r.editor = "",
                            m.value = "",
                            e.replyId && t("cancel-reply")
                        }
                        ), (()=>{
                            y.value = !1
                        }
                    ...
                    return Pr((()=>r.editor), (e=>{
                        const {highlight: t} = n.value;
                        w.value = e,
                        m.value = ((e,t=!0,n)=>(ua().setOptions({
                            highlight: t ? la() : void 0,
                            breaks: !0,
                            smartLists: !0,
                            smartypants: !0
                        }),
                        ua()((e=>e.replace(da, '<p class="vtex">Tex is not available in preview</p>').replace(ca, '<span class="vtex">Tex is not available in preview</span>'))(pa(e, n)))))(e, t, p.value.map),
                        g.value = (e=>(e=>e.match(/[\w\d\s\u00C0-\u024F]+/giu) || [])(e).reduce(((e,t)=>e + ("" === t.trim() ? 0 : t.trim().split(/\s+/u).length)), 0) + (e=>e.match(/[\u4E00-\u9FA5]/gu) || [])(e).length)(e),
                        s.value && (e ? bi(s.value) : bi.destroy(s.value))
                    }
                    ), {
                        immediate: !0
                    }),
                    ...
                    Pr([n, g], (([e,t])=>{
                        const {wordLimit: n} = e;
                        n ? t < n[0] && 0 !== n[0] ? (b.value = n[0],
                        D.value = !1) : t > n[1] ? (b.value = n[1],
                        D.value = !1) : (b.value = n[1],
                        D.value = !0) : (b.value = 0,
                        D.value = !0)
                    }
                    ), {
                    ...
                    )),
                    {
                        ...
                        onLogin: e=>{
                            e.preventDefault();
                            const {lang: t, serverURL: r} = n.value
                              , o = (window.innerWidth - 450) / 2
                              , a = (window.innerHeight - 450) / 2
                              , l = window.open("".concat(r, "/ui/login?lng=").concat(encodeURIComponent(t)), "_blank", "width=".concat(450, ",height=").concat(450, ",left=").concat(o, ",top=").concat(a, ",scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no"));
                            null == l || l.postMessage({
                                type: "TOKEN",
                                data: null
                            }, "*");
                            const s = ({data: e})=>{
                                e && "userInfo" === e.type && e.data.token && (null == l || l.close(),
                                i(e.data),
                                (e.data.remember ? localStorage : sessionStorage).setItem("WALINE_USER", JSON.stringify(e.data)),
                        ...
                        onProfile: e=>{
                            ...
                            const {lang: t, serverURL: r} = n.value
                              ...
                              , s = window.open("".concat(r, "/ui/profile?lng=").concat(encodeURIComponent(t)), "_blank", "width=".concat(800, ",height=").concat(800, ",left=").concat(o, ",top=").concat(l, ",scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no"));
                            null == s || s.postMessage({
                                type: "TOKEN",
                                data: a.value.token
                            }, "*");
                            const u = ({data: e})=>{
                                e && "profile" === e.type && (i(Object.assign({}, a.value, e)),
                                [localStorage, sessionStorage].filter((e=>e.getItem("WALINE_USER"))).forEach((e=>e.setItem("WALINE_USER", JSON.stringify(a)))),
            ...
            wi.render = function(e, t, n, r, o, i) {
                const l = Fn("CloseIcon")
                  ...
                  , v = Fn("LoadingIcon");
                return On(),
                Un("div", Ra, ["disable" !== e.config.login && e.isLogin ? (On(),
                Un("div", Ia, [Zn("div", Oa, [Zn("button", {
                    class: "vlogout-btn",
                ...
                }, null, 8, Ma)])) : Yn("v-if", !0), Zn("div", Ua, ["force" !== e.config.login && e.config.meta.length && !e.isLogin ? (On(),
                Un("div", {
                    key: 0,
                    class: u(["vheader", "vheader-".concat(e.config.meta.length)])
                }, [(On(!0),
                Un(Sn, null, tr(e.config.meta, (t=>(On(),
                Un("div", {
                    class: "vheader-item",
                    key: t
                }, [Zn("label", {
                ...
                }, null, 10, Na), [[To, e.inputs[t]]])])))), 128))], 2)) : Yn("v-if", !0), mn(Zn("textarea", {
                    class: "veditor",
                    ref: "editorRef",
                    id: "waline-edit",
                ...
                }, null, 40, Va), [[Eo, e.inputs.editor]]), Zn("div", {
                    class: "vpreview",
                    style: a({
                ...
                }, [Jn(h)], 10, Qa)]), Zn("div", Ya, [Zn("div", Xa, [Qn(p(e.wordNumber) + " ", 1), e.config.wordLimit ? (On(),
                Un("span", Ga, [ei, Zn("span", {
                    class: u({
                        illegal: !e.isWordNumberLegal
                    }),
                    textContent: p(e.wordLimit)
                }, null, 10, ti)])) : Yn("v-if", !0), Qn("  " + p(e.locale.word), 1)]), "disable" === e.config.login || e.isLogin ? Yn("v-if", !0) : (On(),
                Un("button", {
                    key: 0,
                    class: "vbtn",
                ...
                Un(Sn, null, tr(e.emoji.tabs, ((t,n)=>(On(),
                Un(Sn, {
                    key: t.name
                }, [n === e.emojiTabIndex ? (On(),
                Un("div", oi, [(On(!0),
                Un(Sn, null, tr(t.items, (t=>(On(),
                Un("button", {
                    key: t,
                    title: t,
                ...
                }, null, 8, ii)) : Yn("v-if", !0)], 8, ai)))), 128))])) : Yn("v-if", !0)], 64)))), 128)), e.emoji.tabs.length > 1 ? (On(),
                Un("div", li, [(On(!0),
                Un(Sn, null, tr(e.emoji.tabs, ((t,n)=>(On(),
                Un("button", {
                    key: t.name,
                    ...
                    loading: "lazy",
                    referrerPolicy: "no-referrer"
                }, null, 8, ui)], 10, si)))), 128))])) : Yn("v-if", !0)], 2)])]), e.replyId ? (On(),
                Un("button", {
                    key: 1,
                    class: "vclose",
            ...
            $i.render = function(e, t, n, r, o, a) {
                ...
                Un("img", {
                    ...
                    "aria-hidden": "true",
                    src: e.avatar
                }, null, 8, xi)) : Yn("v-if", !0), Zn("div", Ci, [Zn("div", Ei, [e.link ? (On(),
                Un("a", {
                    key: 0,
                    class: "vnick",
                    href: e.link,
                ...
                Un("span", {
                    ...
                    class: "vnick",
                    textContent: p(e.comment.nick)
                }, null, 8, Fi)), "administrator" === e.comment.type ? (On(),
                Un("span", {
                    key: 2,
                    class: "vbadge",
                    textContent: p(e.locale.admin)
                }, null, 8, _i)) : Yn("v-if", !0), e.comment.sticky ? (On(),
                Un("span", {
                    key: 3,
                    class: "vbadge",
                ...
                }, null, 8, Ii), e.isReplyingCurrent ? (On(),
                Un("div", Oi, [Jn(l, {
                ...
                }, null, 8, ["replyId", "replyUser", "rootId"])])) : Yn("v-if", !0), e.comment.children ? (On(),
                Un("div", ji, [(On(!0),
                Un(Sn, null, tr(e.comment.children, (n=>(On(),
                Pn(s, {
                    key: n.objectId,
                    comment: n,
                    reply: e.reply,
            ...
            const Mi = Qt({
                ...
                setup(e) {
                    ...
                    const c = kt((()=>t.value.locale))
                      , d = e=>{
                        i.value = !0,
                        (({serverURL: e, path: t, page: n, pageSize: r, signal: o})=>fetch("".concat(e, "/comment?path=").concat(encodeURIComponent(t), "&pageSize=").concat(r, "&page=").concat(n), {
                            signal: o
                    ...
                    en((()=>d(1))),
                    {
                        ...
                        onSubmit: e=>{
                            if (e.rid) {
                                const t = l.value.find((({objectId: t})=>t === e.rid));
                                if (!t)
                                    return;
            ...
            Mi.render = function(e, t, n, r, o, a) {
                const i = Fn("CommentBox")
                  ...
                  , s = Fn("CommentCard");
                return On(),
                Un("div", ka, [e.reply ? Yn("v-if", !0) : (On(),
                Pn(i, {
                    key: 0,
                    onSubmit: e.onSubmit
                }, null, 8, ["onSubmit"])), Zn("div", xa, [e.count ? (On(),
                Un("span", {
                    key: 0,
                    class: "vnum",
                    textContent: p(e.count)
                }, null, 8, Ca)) : Yn("v-if", !0), Qn(" " + p(e.locale.comment), 1)]), e.loading && !e.data.length ? (On(),
                Un("div", Ea, [Jn(l, {
                    size: 30
                })])) : Yn("v-if", !0), Zn("div", Aa, [(On(!0),
                Un(Sn, null, tr(e.data, (t=>(On(),
                Pn(s, {
                    key: t.objectId,
                    "root-id": t.objectId,
                    comment: t,
                    ...
                    onReply: e.onReply,
                    onSubmit: e.onSubmit
                }, null, 8, ["root-id", "comment", "reply", "onReply", "onSubmit"])))), 128))]), e.loading && e.data.length ? (On(),
                Un("div", Fa, [Jn(l, {
                    size: 30
                })])) : Yn("v-if", !0), e.data.length || e.loading ? Yn("v-if", !0) : (On(),
                Un("div", {
                    key: 3,
                    class: "vempty",
                    textContent: p(e.locale.sofa)
                }, null, 8, _a)), e.page < e.totalPages && !e.loading ? (On(),
                Un("div", Ba, [Zn("button", {
                    type: "button",
                    class: "vbtn",
                    onClick: t[0] || (t[0] = (...t)=>e.loadMore && e.loadMore(...t)),
                    textContent: p(e.locale.more)
                }, null, 8, Sa)])) : Yn("v-if", !0), e.config.copyright ? (On(),
                Un("div", za, [La, Ta, Qn(" v" + p(e.version), 1)])) : Yn("v-if", !0)])
            }
            ;
            const Ui = Mi;
            var Pi = n(62)
              ...
              , Gi = n(41)
              , el = {};
            el.styleTagTransform = Xi(),
            el.setAttributes = Ji(),
            el.insert = Wi().bind(null, "head"),
            el.domAPI = qi(),
            el.insertStyleElement = Qi(),
            Ni()(Gi.Z, el),
            ...
            class tl {
                constructor() {
                    var e, t;
                    t = void 0,
                    (e = "controller")in this ? Object.defineProperty(this, e, {
                        value: t,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            const nl = (e,t)=>{
                const {path: n, serverURL: r, visitor: o} = e;
                o && (({serverURL: e, path: t, signal: n})=>{
                    const r = (({serverURL: e, path: t})=>fetch("".concat(e, "/article"), {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
                      ...
                      , i = a.filter((e=>e !== t));
                    i.length ? (i.length === a.length ? Promise.resolve() : r).then((()=>(({serverURL: e, paths: t, signal: n})=>fetch("".concat(e, "/article?path=").concat(encodeURIComponent(t.join(","))), {
                        signal: n
                ...
                ((e,t)=>{
                    ...
                    n.length && (({serverURL: e, paths: t, signal: n})=>fetch("".concat(e, "/comment?type=count&url=").concat(encodeURIComponent(t.join(","))), {
                        signal: n
            ...
            function ol(e) {
                ...
                if (!n)
                    return rl("Option 'serverURL' is missing!");
                var r;
                e.dark && "string" == typeof (r = e.dark) && oa("auto" === r ? "@media(prefers-color-scheme:dark){body".concat(ra, "}") : "".concat(r).concat(ra), "waline-dark"),
                e.mathTagSupport && window.addEventListener("load", aa);
                const o = new tl
                  , a = new tl
                  , i = function(e) {
                    return {
                ...
                if (t && !u)
                    return rl("Option 'el' do not match any domElement!");
                let c;
                u && (c = ((...e)=>{
                    ...
                    signal: o.signal
                }).provide("config", l).provide("event", i).provide("version", "1.3.10"),
                c.mount(u));
                const d = {
                    options: e,
                    path: l.value.path
            ...
            ol.Widget = {
                RecentComments: ({el: e, serverURL: t, count: n})=>{
                    const r = e instanceof HTMLElement ? e : e ? document.querySelector(e) : null
                      , o = new AbortController;
                    return (({serverURL: e, count: t, signal: n})=>fetch("".concat(e, "/comment?type=recent&count=").concat(t), {
                        signal: n
